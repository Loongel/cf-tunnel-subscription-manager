...
| V2Ray, PassWall2, sing-box subscriptions | `/sub/v2ray/:token`, `/sub/passwall2/:token`, `/sub/sing-box/:token` implemented; VLESS, VMess, Trojan, Shadowsocks, Hysteria2, and sing-box outbound protocol tests passed. | Unit verified |
