...
func FromEnv() (Config, error) {
	...
	cfg := Config{
		...
		ImageVersion:         stringEnv("IMAGE_VERSION", "ghcr.io/loongel/cf-tunnel-subscription-manager:v0.1.4"),
		HeartbeatInterval:    durationEnv("HEARTBEAT_INTERVAL", 2*time.Minute),
		CommandPollInterval:  durationEnv("COMMAND_POLL_INTERVAL", 2*time.Minute),
